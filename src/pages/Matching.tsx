...
const Matching = () => {
  ...
  const generateMatchDetails = useCallback(
    async (match: UserProfile, user: UserProfile) => {
      setIsFinding(true);
      ...
      `;
        ...
        if (!response.ok)
          throw new Error("Failed to get AI-powered match details.");
  ...
  const personaCardUser = currentMatch
    ? {
        ...currentMatch,
        name: currentMatch.full_name,
        tags: currentMatch.interests,
      }
    : null;
  ...
  const renderContent = () => {
        ...
        <Card className="text-center py-16 animate-scale-in">
          <CardContent>
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">
              Our AI will find someone who shares your interests and values.
            </p>
            <Button
              size="lg"
              onClick={fetchAndProcessMatches}
              className="px-8"
              disabled={isFinding}
            >
    ...
    if (!currentMatch || !personaCardUser) {
      return (
        <Card className="text-center py-16">
          <CardContent>
            <h3 className="text-xl font-semibold">No more matches for now.</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              {!matchDetails ? (
                <p className="text-muted-foreground">Generating details...</p>
              ) : (
                <>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {matchDetails.sharedInterests.map((interest) => (
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="space-y-2 text-xs text-muted-foreground">
                      <div className="flex items-center pt-1">
                        ...
                        {currentMatch.email || "No email"}
                      </div>
                      <div className="flex items-center pt-1">
                        <Phone className="mr-2 h-3 w-3" />
                        {currentMatch.phone_number || "No phone"}
                      </div>
                      <div className="flex items-center pt-1">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {!matchDetails ? (
                ...
                matchDetails.conversationStarters.map((starter, index) => (
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              {!matchDetails ? (
                ...
                matchDetails.interactionTips.map((tip, index) => (
                  <p key={index}>• {tip}</p>
                ))
              )}
            </CardContent>
      ...
      {currentMatch && (
        <ChatPopup
          ...
          user={{
            ...
            conversationTips: matchDetails?.conversationStarters || [
              "Start with a simple 'Hello!'",
            ],
          }}
          onDmClick={() => {
            setChatPopupOpen(false);
            navigate(`/chats/${currentMatch.id}`, {
